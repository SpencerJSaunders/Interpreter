...
public class Scanner {
    ...
    private void nextKwOperator()
    {
    	int old = pos;
    	many(operators);
    	Token current;
    	String lexeme = program.substring(old, pos);
    	current = new Token(lexeme);
    	Token negativeEquals = new Token("=-");

    	if(current.equals(negativeEquals))
    	{
    		pos = old;
    		nextKwSymbol();
    	}
    ...
    public double pos() { return (double) pos; }
